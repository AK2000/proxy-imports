...
def import_module():
    ...
    importlib.reload(proxynp) # reload to as numpy was already loaded into memory by :`proxy_module`:
    assert package_path in inspect.getfile(proxynp), inspect.getfile(proxynp) # make sure correct numpy is being used
